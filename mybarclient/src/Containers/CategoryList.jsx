...
class CategoryList extends Component {
    ...
    updatePage(newUrl){
        ...
        console.log('http://localhost:8080/filteredDrinks/' + newUrl)
        axios.get('http://localhost:8080/filteredDrinks/' + newUrl)
            .then((response) => {
                        ...
                        <div className="Grid">
                            {this.state.drinks &&
                                this.state.drinks.map((drink,index) => <span onClick={(e) => this.toggleModal(e)}>
                                                                            <DrinkCard 
                                                                                key={index} 
                                                                                imageUrl={`http://localhost:8080/images/drinks/${drink.name.replace(/ /g,'_')}.jpg`} 
